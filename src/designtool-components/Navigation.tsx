    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:block py-4">
            <div className="flex items-center justify-between">
              ...
              {/* Desktop Dropdown */}
              <div className="relative desktop-dropdown z-[110]">
                <button
                ...
                {/* Dropdown Menu */}
                {desktopDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-[120] max-h-96 overflow-y-auto">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[110] md:hidden">
          ...
          {/* Menu Panel */}
          <div className="fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-[120]">
